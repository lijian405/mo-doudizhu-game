...
游戏主界面底部操作按钮区域新增一个“要不起”按钮，主要功能与“不出”一样。

### 核心逻辑

- 每轮出牌，服务端要根据本次出的牌和下一家出牌的玩家手里的牌计算出该玩家手里的牌是否有能大过本次出的牌，如果没有，则通知该玩家。

* 当玩家手里的牌没有能大过上家出的牌时，显示该按钮，另外“不出”和“出牌”按钮隐藏。

## 出牌提示功能

游戏主界面底部操作按钮区域新增一个“提示”按钮，放在“不出”按钮和“出牌”的中间，主体色为绿色，主要功能是帮助玩家自动选中可以压过上一家出牌的最优出牌方案

### 设计思路

- 此功能需要客户端和服务端交互完成

* 玩家点击“提示按钮”，服务端会依据当前玩家手里的牌和上家出的牌，根据出牌规则计算出该玩家出牌的最优方案，并把可以出的牌通知到该客户端
* 客户端接到通知后，自动选中这些牌，由玩家自己点击“出牌”，客户端只作选中手牌效果，不需要自动出牌。
* 如果当前玩家没有比上家大的牌，则提醒“没有更大的牌了”。
* 如果最后出牌的玩家是当前玩家，则选中手牌中最小的牌出。
